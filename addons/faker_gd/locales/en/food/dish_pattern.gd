class_name FakerEnFoodDishPattern
extends RefCounted
...
const DATA = [
	...
	"{{food.adjective}} {{food.vegetable}} and {{food.ingredient}} bowl",
	"{{food.adjective}} {{food.vegetable}} curry",
	"{{food.adjective}} {{food.vegetable}} with {{food.fruit}} glaze",
	"{{food.ethnic_category}} {{food.ingredient}} soup",
	"{{food.fruit}} and {{food.fruit}} tart",
	"{{food.fruit}} pie",
	"{{food.fruit}}-glazed {{food.meat}} skewers",
	"{{food.fruit}}-glazed {{food.vegetable}} skewers",
