class_name FakerEnCommerceProductDescription
extends RefCounted

const DATA = [
	"Discover the {{animal.type}}-like agility of our {{commerce.product}}, perfect for {{word.adjective}} users",
	"Discover the {{word.adjective}} new {{commerce.product}} with an exciting mix of {{commerce.product_material}} ingredients",
	"Ergonomic {{commerce.product}} made with {{commerce.product_material}} for all-day {{word.adjective}} support",
	...
	"Innovative {{commerce.product}} featuring {{word.adjective}} technology and {{commerce.product_material}} construction",
	...
	"The {{company.catch_phrase}} {{commerce.product}} offers reliable performance and {{word.adjective}} design",
	"The {{person.first_name}} {{commerce.product}} is the latest in a series of {{word.adjective}} products from {{company.name}}",
	"{{commerce.product_adjective}} {{commerce.product}} designed with {{commerce.product_material}} for {{word.adjective}} performance",
